...
Este repositório contém o Projeto de Extensão III desenvolvido para a Mercado Dal- Bo Ltda, demonstrando meu compromisso com a segurança da informação e com as políticas internas da organização parceira.
...
Este projeto segue as diretrizes estabelecidas no acordo de confidencialidade firmado com a Mercado Dal- Bo Ltda e está em conformidade com a Lei Geral de Proteção de Dados (LGPD).
