...
Este é um **Projeto de Extensão Universitária (Pex III)**, realizado como atividade acadêmica de impacto social no CST em Ciência de Dados (UniAmérica Descomplica - 3º Semestre).
---
...
O projeto **Financeiro Pro** foi desenvolvido como solução prática para um problema real identificado em uma organização parceira durante o **Projeto de Extensão III** do curso de Tecnologia em Ciência de Dados.

### 🔍 Problema Diagnosticado

A empresa parceira enfrentava dificuldades significativas no gerenciamento de despesas e receitas, utilizando exclusivamente planilhas eletrônicas (Excel) que resultavam em:

- **Falta de padronização** nos registros de transações
- **Impossibilidade de análises rápidas** para tomada de decisão
- **Erros manuais** frequentes em cálculos
- **Dificuldade em identificar padrões** de gastos
- **Ausência de visualizações gráficas** dos dados
- **Perda de tempo** em processamento manual de informações

### 💡 Solução Desenvolvida

Foi criada uma **aplicação web intuitiva** chamada **Financeiro Pro** que oferece:

✅ Interface amigável para lançamento de receitas e despesas  
✅ Categorização automática de transações  
✅ Dashboard com resumo visual  
✅ 5 gráficos analíticos diferentes  
✅ Filtros por período  
✅ Histórico completo de lançamentos  
✅ Gestão customizável de categorias e formas de pagamento  

### 📊 Impacto Gerado

- **Otimização de tempo:** Redução no tempo de lançamento e cálculo de dados
- **Melhor tomada de decisão:** Visualização clara de padrões de gasto
- **Precisão:** Eliminação de erros manuais
- **Escalabilidade:** Possibilidade de expansão futura com análises preditivas
...
- **Escopo:** Solução de Dados para Organização Parceira
- **Tecnologias:** Python, Flask, Web Development, Data Visualization
...
Se sua empresa deseja utilizar esta solução ou conceitos semelhantes em ambiente de produção, é necessário:
...
Este projeto foi desenvolvido como atividade de Extensão Universitária (Pex III) com o objetivo de **gerar impacto social e tecnológico** através da aplicação prática de técnicas de ciência de dados.

**Agradecimentos:**
- 🎓 Instituição: Descomplica Faculdade Digital / UniAmérica
- 🤝 Organização Parceira: Pela confiança e oportunidade de parceria
